namespace Flatout3_MusicTool
{
    partial class Extracting
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Game files are being extracted right now...\r\nThis process may take between 3-20mi" +
    "n, depending on your CPU and disk drive speeds.\r\nThe bar above will be updated w" +
    "hen each step is completed.";
            // 
            // Extracting
            // 
